...
- **w8**: обе недели по воскресному снапшоту (created_at и converted_at не меняются). Контракты по converted_at. Оферты недели = разница со снапшотом ровно за прошлое воскресенье (`transition_flags`), иначе «—»; изменение оферт к прошлой неделе не считается: нужен снапшот двухнедельной давности. Изменение = (эта − прошлая) / прошлая; при равенстве 0, при нуле в прошлой неделе «—».
