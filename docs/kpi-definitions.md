...
- **Окно недели** (w2, w3, w4, визиты и контракты в w8): [Вс 19:00 прошлой недели, Вс 19:00) = семь ежедневных окон d1. День визита в w2 = день ежедневного окна.
...
- **w8**: обе недели по воскресному снапшоту (created_at и converted_at не меняются). Контракты по converted_at. Оферты недели = разница со снапшотом ровно за прошлое воскресенье (`transition_flags`), иначе «—»; изменение оферт к прошлой неделе не считается: нужен снапшот двухнедельной давности. Изменение = (эта − прошлая) / прошлая; прошлое значение 0 даёт «—» всегда, в том числе 0 против 0.
